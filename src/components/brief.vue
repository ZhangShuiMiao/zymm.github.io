<template>
  <div class="brief">
    <div class="avatar">
      <EditImage :src="require('@/assets/mine.jpg')" width="200" height="200" :isCircle="true" class="img"></EditImage>
      <!-- <img src="./assets/photo.png" alt="photo"> -->
      <div class="name" contenteditable="true">张水淼</div>
      <div class="job" contenteditable="true">前端工程师</div>
      <div class="location">
        <img src="../assets/location.png"  alt="">
        <div class="location-name" contenteditable="true">湖北 黄石</div>
      </div>
    </div>
    <div class="info">
      <ul>
